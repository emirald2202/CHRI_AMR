...
const resources = {
  en: {
    translation: {
      ...
      "gotIt": "Got it ✓", "mapsTitle": "Google Maps Integration", "mapsSub": "Interactive map with pharmacy markers will appear here",
  ...
  hi: {
    translation: {
      ...
      "gotIt": "समझ गया ✓", "mapsTitle": "गूगल मैप्स", "mapsSub": "फार्मेसी मार्करों वाला नक्शा यहां दिखाई देगा", "trackerTitle": "निपटान क्रियाएँ", "trackerSub": "निर्धारण बटन और सक्रिय अनुरोध ट्रैकर",
  ...
  mr: {
    translation: {
      ...
      "gotIt": "समजले ✓", "mapsTitle": "गुगल मॅप्स", "mapsSub": "मार्करसह नकाशा येथे दिसेल", "trackerTitle": "विल्हेवाट कृती", "trackerSub": "शेड्युलिंग आणि ट्रॅकर",
